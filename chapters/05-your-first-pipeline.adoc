...
* Browse to your Jenkins instance
...
== Follow-along: Initialize Your First Pipeline 1/3

* Follow the presenter instruction to create a new Pipeline,
...
== Follow-along: Initialize Your First Pipeline 2/3
...
== Follow-along: Initialize Your First Pipeline 3/3
...
* Save, add a commit message and see the build kicks off
